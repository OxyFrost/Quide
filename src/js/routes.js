...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  */
  ...
  .state('mesLieuxInsolites', {
    url: '/page1',
    templateUrl: 'templates/mesLieuxInsolites.html',
    controller: 'mesLieuxInsolitesCtrl'
  })

  .state('mesPublications', {
    url: '/page3',
    templateUrl: 'templates/mesPublications.html',
    controller: 'mesPublicationsCtrl'
  })

  .state('mesInformations', {
    url: '/page4',
    templateUrl: 'templates/mesInformations.html',
    controller: 'mesInformationsCtrl'
  })
